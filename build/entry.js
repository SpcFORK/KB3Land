...
(__oak_modularize(__Oak_String(``),function _(){return ((wow)=>(wow=function wow(){return (print(__Oak_String(`wow`)))},({wow})))()}),(__Oak_Import_Aliases=({})),__oak_module_import(__Oak_String(``)))
